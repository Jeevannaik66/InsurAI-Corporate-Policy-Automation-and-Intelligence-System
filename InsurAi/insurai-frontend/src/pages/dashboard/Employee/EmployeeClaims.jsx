      ...
      <div className="row mb-4">
        <div className="col-12">
          <div className="d-flex justify-content-between align-items-center mb-4">
            <div>
              <h4 className="fw-bold text-gray-800 mb-1">My Insurance Claims</h4>
              ...
              <div className="modal-body py-4">
                <div className="row">
                  ...
                  <div className="col-md-6">
                    ...
                    <div className="mb-3">
                      <label className="fw-semibold text-gray-600 small">Policy ID</label>
                      <p className="mb-0 text-gray-700">#{viewingClaim.policyId}</p>
                    </div>
                    <div className="mb-3">
