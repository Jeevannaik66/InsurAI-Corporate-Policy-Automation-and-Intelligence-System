...
export default function EmployeeQueries({
  ...
  // Enhanced query filtering and sorting
  const filteredAndSortedQueries = useMemo(() => {
    let filtered = queries.filter(query => {
      const matchesSearch = query.queryText?.toLowerCase().includes(searchTerm.toLowerCase()) ||
  ...
  const getStatusColor = (query) => {
    const isAnswered = query.response && query.response.trim() !== "";
    return isAnswered ? 'success' : 'warning';
  };

  const getStatusIcon = (query) => {
    const isAnswered = query.response && query.response.trim() !== "";
    return isAnswered ? 'bi-check-circle-fill' : 'bi-clock-fill';
  };

  // Enhanced Ask Query Form
  const renderAskQuery = () => (
    <div className="p-4">
      {/* Header Section */}
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div>
          <h4 className="fw-bold text-gray-800 mb-1">Ask a Question</h4>
              ...
              <form onSubmit={handleQuerySubmit}>
                ...
                <div className="mb-4">
                  ...
                  <textarea
                    ...
                    placeholder="Please provide detailed information about your question or issue. The more specific you are, the better we can assist you..."
                    required
                    style={{ resize: 'vertical' }}
                  ></textarea>
                  <div className="form-text text-gray-600">
                    <i className="bi bi-info-circle me-1"></i>
                    Please include relevant policy numbers, claim IDs, or specific dates if applicable.
                  </div>
                </div>
                ...
                <div className="mb-4">
                  ...
                  >
                    ...
                    {agentsAvailability.length > 0 ? (
                      ...
                      <option value="" disabled>No agents available at the moment</option>
                    )}
                  </select>
                  <div className="form-text text-gray-600">
                    <i className="bi bi-lightbulb me-1"></i>
                    Online agents typically respond within 2-4 hours
                  </div>
                </div>
  ...
  const renderMyQueries = () => (
    <div className="p-4">
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div>
          <h4 className="fw-bold text-gray-800 mb-1">My Support Queries</h4>
                  ...
                  {filteredAndSortedQueries.map((query) => {
                    ...
                    return (
                      <tr key={query.id} className="border-bottom">
                        <td>
                          <strong className="text-primary">#{query.id}</strong>
                        </td>
                        <td>
                          <div className="text-truncate text-gray-800" style={{maxWidth: '200px'}} 
                        ...
                        <td>
                          {isAnswered ? (
                            <div className="text-truncate text-success" style={{maxWidth: '200px'}}
                        ...
                        <td>
                          <small className="text-gray-600">
                            {query.createdAt ? new Date(query.createdAt).toLocaleDateString('en-IN') : "-"}
                          </small>
                        </td>
                        <td>
              ...
              <div className="card-body">
                ...
                <div className="mb-4">
                  ...
                  <div className="border rounded p-3 bg-light">
                    <p className="mb-0 text-gray-800" style={{ whiteSpace: 'pre-wrap' }}>{selectedQuery.queryText}</p>
                  </div>
                </div>
                ...
                <div className="card-body">
                  ...
                  {!isAnswered && (
                    <button
                      ...
                      onClick={() => {
                        // Refresh the query to check for updates
